...
const optionsSchema_json_1 = require("webpack-dev-server/lib/optionsSchema.json");
...
const optionsSchema_json_2 = require("./utils/optionsSchema.json");
...
class AddGenerator extends Generator {
    ...
    prompting() {
        ...
        return this.prompt([
            ...
            const webpackSchemaProp = optionsSchema_json_2.default.definitions[action];
            /*
            ...
            let defOrPropDescription = webpackSchemaProp
                ...
                : optionsSchema_json_2.default.properties[action].properties
                    ? optionsSchema_json_2.default.properties[action].properties
                    : optionsSchema_json_2.default.properties[action].anyOf
                        ? optionsSchema_json_2.default.properties[action].anyOf.filter((p) => p.properties || p.enum)
                        : null;
            ...
            const webpackDevserverSchemaProp = action === "devServer" ? optionsSchema_json_1.default : null;
                ...
                if (pluginExist) {
                    ...
                    npm_exists_1.default(answerToAction.actionAnswer)
                        ...
                        if (p) {
                            ...
                            this.runInstall(package_manager_1.getPackageManager(), this.dependencies, {
                                "save-dev": true,
                            });
                        }
                        else {
