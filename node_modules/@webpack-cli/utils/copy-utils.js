...
exports.generatorCopy = (generator, templateDir) => (filePath) => {
    ...
    generator.fs.copy(path.join.apply(null, sourceParts), generator.destinationPath(path.join.apply(null, targetParts)));
};
/**
 * Takes in a file path in the `./templates` directory. Copies that
...
exports.generatorCopyTpl = (generator, templateDir, templateData) => (filePath) => {
    ...
    generator.fs.copyTpl(path.join.apply(null, sourceParts), generator.destinationPath(path.join.apply(null, targetParts)), templateData);
};
